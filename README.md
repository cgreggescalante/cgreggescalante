...
Currently, I'm working on a web application to help analyze the data generated through the use of a [Stryd Pod](https://www.stryd.com/us/en) (a fancy running tool used to measure power, vertical oscillation, and many other metrics). I am writing it with a Angular frontend, and an Express backend. At some point in the future I hope to deploy the app to a Raspberry Pi, but they are very hard to come by these days.
